...
#'
#' @examples
#' df<-regacc_load_matis("E:/03_Regional Accounts/03D_Data Production/2021/BE/matis/t1200_BE_01.xlsx",
#' keep_cols= c("type","ref_area","sto","activity","time","values"))
#'
regacc_load_matis <- function(file,
...
df <-rio::import(file) %>%
  ...
  df[, c("VAL","type", "table_identifier", "freq", "ref_area","counterpart_area","ref_sector","counterpart_sector",
