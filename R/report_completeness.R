...
#'
#'The function provides the same ratios as reported in the NQR and an interactive table wit the missing values.
...
#'
report_completeness<- function(data, table_sel){
  options(warn = - 1)
  ...
  ratio_1001<-round((tot_1001-notrep_1001_n)*100/tot_1001,2) #calculate the ratio
  print (paste0("Coverage for t1001 is:", ratio_1001))
  ...
  if("T1002" %in% table_sel){
    ...
    ratio_1002<-round((tot_1002-notrep_1002_n)*100/tot_1002,2) #calculate the ratio
    print (paste0("Coverage for t1002 is:", ratio_1002))
  ...
  if("T1200" %in% table_sel){
    ...
    ratio_1200<-round((tot_1200-notrep_1200_n)*100/tot_1200,2) #calculate the ratio
    print (paste0("Coverage for t1200 is:", ratio_1200))
  ...
  if("T1300" %in% table_sel){
    ...
    ratio_1300<-round((tot_1300-notrep_1300_n)*100/tot_1300,2) #calculate the ratio
    print (paste0("Coverage for t1300 is:", ratio_1300))
